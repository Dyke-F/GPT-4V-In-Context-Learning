...
def load_features(task, config):
    path = f"/mnt/bulk/dferber/ICL_REVISION/features/phikon_{task}_features.npy"
...
def inference_phikon_lin_probing(task: str, config: dataclass, phikon_out_dim: int = 768):
