###
# Minor plotting changes to make figures for publication.
###
...
def confusion_matrix(
    ...
    *,
    ...
    plt.tight_layout()
    plt.savefig(f"{save_path}_confusion_matrix_paper_purple_line.pdf", dpi=300)
    plt.savefig(f"{save_path}_confusion_matrix_paper_purple_line.png", dpi=300)
...
def auroc(
    ...
    *,
    ...
    plt.tight_layout()
    plt.savefig(f"{save_path}_roc_curve.pdf", dpi=300)
